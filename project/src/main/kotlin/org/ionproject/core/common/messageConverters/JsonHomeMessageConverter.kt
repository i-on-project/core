...
import org.ionproject.core.home.JsonHome
...
class JsonHomeMessageConverter(private val converter: MappingJackson2HttpMessageConverter) : AbstractGenericHttpMessageConverter<JsonHome>(Media.MEDIA_HOME) {
